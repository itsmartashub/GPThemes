...
function handleColorInput() {
    $settings.addEventListener("click", (e)=>{
        ...
        if (e.target.id === "accentLight") e.target.addEventListener("input", (e)=>{
            updateCSSVars(e.target.value, null);
        });
        if (e.target.id === "accentDark") e.target.addEventListener("input", (e)=>{
